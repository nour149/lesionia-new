...
/* harmony import */ var _patient_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./patient.component */ "eXkR");
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "8Y7J");
/* harmony import */ var _patient_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./patient.component */ "eXkR");
/* harmony import */ var _patient_routing_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./patient-routing.module */ "5rTm");
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _raw_loader_patient_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! raw-loader!./patient.component.html */ "d4y1");
/* harmony import */ var _patient_component_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./patient.component.css */ "eBa3");
...
let PatientComponent = class PatientComponent {
    ...
    ngOnInit() { this.get_patients(); }
    get_patients() {
        this.patientservice.get_patients().subscribe(data => {
            if (data.status == 200) {
    ...
    search() {
        if (this.id1 == "") {
            ...
            this.patients = this.patients.filter(res => {
                return res.patientidentifier.match(this.id1);
            });
            this.totallength = this.patients.length;
    ...
    tt() {
        if (this.id.length == 0)
            ...
            this.numberitem = this.totallength;
    }
};
...
PatientComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_services_patient_service__WEBPACK_IMPORTED_MODULE_5__["PatientService"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"]])
], PatientComponent);
...
//# sourceMappingURL=views-patient-patient-module-es2015.js.map