...
module.exports = __webpack_require__(/*! C:\angular_project\coreui-free-angular-admin-template-master\src\main.ts */"zUnb");
...
/* harmony import */ var ngx_cookie__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ngx-cookie */ "4pnn");
...
DefaultLayoutComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"], ngx_cookie__WEBPACK_IMPORTED_MODULE_4__["CookieService"]])
...
/* harmony import */ var _login_component_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./login.component.css */ "XzSN");
...
/* harmony import */ var ngx_cookie__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ngx-cookie */ "4pnn");
/* harmony import */ var _services_user_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../services/user.service */ "qfBg");
/* harmony import */ var ngx_bootstrap_alert__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ngx-bootstrap/alert */ "CNMR");
/* harmony import */ var crypto_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! crypto-js */ "NFKh");
...
let LoginComponent = class LoginComponent {
    ...
    login() {
        if (this.loginForm.valid) {
            ...
            this.userservice.login(this.loginForm.value).subscribe(data => {
                ...
                this.decoded = Object(jwt_decode__WEBPACK_IMPORTED_MODULE_6__["default"])(data.access_token);
                localStorage.setItem('current_user_id', this.decoded.sub);
            ...
            if (username == "") {
                let element2 = document.getElementById('username');
                element2.className = element2.className + " is-invalid";
            }
        }
    }
    add() {
    ...
    pass() {
        this.userservice.check_email(this.email).subscribe((response) => {
            if (response.body.result == "not found")
                this.bad_email(response.body.result);
            else {
                this.code_email = response.body.result;
                this.email_section = false;
                this.code_section = true;
                this.conversionEncryptOutput = crypto_js__WEBPACK_IMPORTED_MODULE_10__["AES"].encrypt(this.code_email, "secure_code").toString();
    ...
    change_password() {
        ...
        if (new_mdp != confirm_mdp) {
            ...
            let element = document.getElementById('confirm_mdp');
            element.className = "form-control";
            this.userservice.change_pw_email(this.email, new_mdp).subscribe((response) => {
                this.cancel_change();
...
LoginComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
        ...
        providers: [{ provide: ngx_bootstrap_alert__WEBPACK_IMPORTED_MODULE_9__["AlertConfig"] }],
        styles: [_login_component_css__WEBPACK_IMPORTED_MODULE_2__["default"]]
    }),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_services_user_service__WEBPACK_IMPORTED_MODULE_8__["UserService"], _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"],
...
/* harmony import */ var _req_interceptor__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./req.interceptor */ "pblR");
...
/* harmony import */ var ngx_bootstrap_alert__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ngx-bootstrap/alert */ "CNMR");
...
/* harmony import */ var ngx_cookie__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ngx-cookie */ "4pnn");
/* harmony import */ var ng2_search_filter__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ng2-search-filter */ "cZdB");
...
AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        imports: [
            ...
            ngx_cookie__WEBPACK_IMPORTED_MODULE_23__["CookieModule"].forRoot(),
        ...
        providers: [
            ...
            { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_21__["HTTP_INTERCEPTORS"], useClass: _req_interceptor__WEBPACK_IMPORTED_MODULE_8__["ReqInterceptor"], multi: true },
...
/* harmony import */ var _services_auth_guard__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./services/auth.guard */ "+VzF");
...
const routes = [
    ...
    },
    {
        ...
        children: [
            {
                path: 'patients',
                loadChildren: () => Promise.all(/*! import() | views-patient-patient-module */[__webpack_require__.e("common"), __webpack_require__.e("views-patient-patient-module")]).then(__webpack_require__.bind(null, /*! ./views/patient/patient.module */ "IrFo")).then(m => m.PatientModule)
            },
            {
                path: 'dossier',
                loadChildren: () => __webpack_require__.e(/*! import() | views-dossier-dossier-module */ "views-dossier-dossier-module").then(__webpack_require__.bind(null, /*! ./views/dossier/dossier.module */ "n3jh")).then(m => m.DossiertModule)
            },
            {
                path: 'users',
            ...
            {
                path: 'profil',
                loadChildren: () => __webpack_require__.e(/*! import() | views-profil-profil-module */ "views-profil-profil-module").then(__webpack_require__.bind(null, /*! ./views/profil/profil.module */ "hT5q")).then(m => m.ProfilModule)
            },
            {
                path: 'laboratory',
                loadChildren: () => __webpack_require__.e(/*! import() | views-laboratory-laboratory-module */ "views-laboratory-laboratory-module").then(__webpack_require__.bind(null, /*! ./views/laboratory/laboratory.module */ "8AtP")).then(m => m.LaboratoryModule)
            },
            {
                path: 'leishmania-species',
                loadChildren: () => __webpack_require__.e(/*! import() | views-leishmania-species-leishmania-species-module */ "views-leishmania-species-leishmania-species-module").then(__webpack_require__.bind(null, /*! ./views/leishmania-species/leishmania-species.module */ "THWx")).then(m => m.LeishmaniaSpeciesModule)
            },
            {
                path: ' MolecularlTest',
                loadChildren: () => __webpack_require__.e(/*! import() | views-molecularl-test-molecularl_test-module */ "views-molecularl-test-molecularl_test-module").then(__webpack_require__.bind(null, /*! ./views/molecularl-test/molecularl_test.module */ "ipN1")).then(m => m.MolecularlTestModule)
            },
            {
                path: 'disease',
                loadChildren: () => __webpack_require__.e(/*! import() | views-disease-disease-module */ "views-disease-disease-module").then(__webpack_require__.bind(null, /*! ./views/disease/disease.module */ "AdbA")).then(m => m.DiseaseModule)
            },
            {
                path: 'charts',
                loadChildren: () => __webpack_require__.e(/*! import() | views-chartjs-chartjs-module */ "views-chartjs-chartjs-module").then(__webpack_require__.bind(null, /*! ./views/chartjs/chartjs.module */ "Y+KY")).then(m => m.ChartJSModule), canActivate: [_services_auth_guard__WEBPACK_IMPORTED_MODULE_4__["AuthGuard"]]
            },
            {
                path: 'dashboard',
                loadChildren: () => Promise.all(/*! import() | views-dashboard-dashboard-module */[__webpack_require__.e("common"), __webpack_require__.e("views-dashboard-dashboard-module")]).then(__webpack_require__.bind(null, /*! ./views/dashboard/dashboard.module */ "6dU7")).then(m => m.DashboardModule), canActivate: [_services_auth_guard__WEBPACK_IMPORTED_MODULE_4__["AuthGuard"]]
            },
            {
                path: 'icons',
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ReqInterceptor", function() { return ReqInterceptor; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "8Y7J");
/* harmony import */ var ngx_cookie__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ngx-cookie */ "4pnn");
...
ReqInterceptor.ctorParameters = () => [
    { type: ngx_cookie__WEBPACK_IMPORTED_MODULE_2__["CookieService"] }
];
ReqInterceptor = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])(),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [ngx_cookie__WEBPACK_IMPORTED_MODULE_2__["CookieService"]])
], ReqInterceptor);
...
let UserService = class UserService {
    ...
    login(obj) {
        ...
        return this.http.post(this.baseurl + `login`, formData, { responseType: 'json' });
    }
    get_all_users() {
        return this.http.get(this.baseurl + 'user/all', { observe: 'response' });
    }
    get_interrogator(loginuser) {
        return this.http.get(this.baseurl + `user/interrogator/` + loginuser);
    }
    save(loginuser, obj) {
        return this.http.post(this.baseurl + 'user/register/' + loginuser, obj, { observe: 'response' });
    }
    get_user(loginuser) {
        return this.http.get(this.baseurl + "user/" + loginuser);
    }
    verif_pass(loginuser, mdp) {
        return this.http.post(this.baseurl + "user/verif/pass/" + loginuser + "/" + mdp, { observe: 'response' });
    }
    change_mdp(loginuser, mdp) {
        return this.http.put(this.baseurl + "user/update/pw/" + loginuser + "/" + mdp, { observe: 'response' });
    }
    check_email(email) {
        return this.http.get("http://lesionia.pasteur.tn:7000/free/verif_email/" + email, { observe: 'response' });
    }
    change_pw_email(email, pw) {
        return this.http.post("http://lesionia.pasteur.tn:7000/free/change_pw/" + email + "/" + pw, { observe: 'response' });
    }
    update(obj) {
        return this.http.put(this.baseurl + "user/", obj, { observe: 'response' });
    }
    delete(loginuser) {
        return this.http.delete(this.baseurl + "user/" + loginuser, { observe: 'response' });
    }
    islogged() {
...
UserService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"], ngx_cookie__WEBPACK_IMPORTED_MODULE_3__["CookieService"]])
], UserService);
