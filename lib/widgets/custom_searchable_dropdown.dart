            ...
            for (int j = 0; j < widget.initialValue!.length; j++) {
              if (widget.initialValue != null && widget.initialValue!.isNotEmpty) {
                if (widget.initialValue![j]['value'] ==
                  ...
                  selectedValues.add(
                      widget.dropDownMenuItems[i].toString() + '-_-' + i.toString());
                  setState(() {});
                }
              }
            }
            ...
            Container(
              ...
              child: TextButton(
                style: TextButton.styleFrom(
                  ...
                  foregroundColor: widget.primaryColor ?? Colors.black, // Replaced 'primary'
                ...
                child: Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      ((widget.multiSelect == true && widget.multiSelect != null) &&
                          selectedValues.isNotEmpty)
                          ? Expanded(
                        child: (widget.multiSelectValuesAsWidget == true &&
                      ...
                      child: SizedBox(
                        ...
                        child: Padding(
                          ...
                          child: Checkbox(
                            ...
                            value: selectedValues.contains(newDataList[index])
                                ? true
                                : false,
